...
for (const l of Object.values(langs)) { l.review = reviews[l.code]; l.visit = visitLabels[l.code]; l.map = mapLabels[l.code]; l.menu = menus[l.code]; l.featured = featuredMenus[l.code]; l.aboutText = aboutTexts[l.code]; l.verified = sourceTexts[l.code]; }
